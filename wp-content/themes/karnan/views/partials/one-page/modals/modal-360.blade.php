<div id="modal-target-{{ sanitize_title($section['section_title']) }}-360" data-section-name="{{ sanitize_title($section['section_title']) }}" class="modal modal-backdrop-white modal-medium modal-karnan modal-360" tabindex="-1" role="dialog" aria-hidden="true">
